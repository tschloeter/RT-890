...
PCB_VER_2_1						?= 0
DISALLOW_TRANSMIT 				?= 0
FM_RADIO_FULLSCREEN				?= 1
SFLASH_FULL_WRITE_CMD			?= 0
...
ifeq ($(DISALLOW_TRANSMIT), 1)
	CFLAGS += -DDISALLOW_TRANSMIT
endif
ifeq ($(FM_RADIO_FULLSCREEN), 1)
	CFLAGS += -DFM_RADIO_FULLSCREEN
endif
ifeq ($(SFLASH_FULL_WRITE_CMD), 1)
	CFLAGS += -DSFLASH_FULL_WRITE_CMD
endif
